...
def calculate_negative_avg_score():
    """
    Calculate average max_score for user1, user2, user3, and user4 from their false_negative_compare_results JSON files
    and save the result in avg_score.json in each user's false_negative_compare_results folder.
    Also includes summary of scores greater than 5.
    """
    users_dir = "Users"
    target_users = ["user1", "user2", "user3", "user4"]  # Process these users
